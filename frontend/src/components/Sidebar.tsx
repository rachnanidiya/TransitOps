...
const Sidebar: React.FC = () => {
  return (
    <aside className="hidden md:block w-64 bg-dark-bg border-r border-border">
      ...
      <nav className="mt-6 space-y-1">
        <NavLink
          ...
          className={(props) => `
            ...
            ${props.isActive ? 'bg-dark-primary/20 text-dark-primary border-l-4 border-dark-primary' : 'hover:bg-dark-surface/30 text-white/90'}
          `}
        >
          <DashboardIcon className="mr-4 h-5 w-5 text-dark-primary" />
          Dashboard
        </NavLink>
        ...
        <NavLink
          ...
          `}
        >
          <TruckIcon className="mr-4 h-5 w-5 text-dark-primary" />
          Vehicles
        </NavLink>
        ...
        <NavLink
          ...
          `}
        >
          <UsersIcon className="mr-4 h-5 w-5 text-dark-primary" />
          Drivers
        </NavLink>
        ...
        <NavLink
          ...
          `}
        >
          <MapPinIcon className="mr-4 h-5 w-5 text-dark-primary" />
          Trips
        </NavLink>
        ...
        <NavLink
          ...
          `}
        >
          <WrenchIcon className="mr-4 h-5 w-5 text-dark-primary" />
          Maintenance
        </NavLink>
        ...
        <NavLink
          ...
          `}
        >
          <PiggyBankIcon className="mr-4 h-5 w-5 text-dark-primary" />
          Expenses
        </NavLink>
        ...
        <NavLink
          ...
          `}
        >
          <ChartBarIcon className="mr-4 h-5 w-5 text-dark-primary" />
          Reports
        </NavLink>
      </nav>
    </aside>
...
// Simple icon components with proper styling
...
const PiggyBankIcon = ({ className }: { className?: string }) => <svg className={className || "h-5 w-5"} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2c2.21 0 4 1.79 4 4v1h4a2 2 0 012 2v9a2 2 0 01-2 2H6a2 2 0 01-2-2v-9a2 2 0 012-2h4V6c0-2.21 1.79-4 4-4z"/><circle cx="12" cy="13" r="3"/></svg>;
